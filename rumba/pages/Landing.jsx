...
function Landing() {
    ...
    return (
        <>
            ...
            {/* MÉTRICAS */}
            <section className="catalog-section" style={{ paddingTop: "2rem", paddingBottom: "2rem" }}>
                <div className="catalog-table">
                    ...
                    >
                        <div>
                            <div className="card-stat-num" style={{ fontSize: "2.2rem" }}>6</div>
                            <div className="cell-muted">Tipos de proyecto</div>
                        </div>
                        <div>
                            <div className="card-stat-num" style={{ fontSize: "2.2rem" }}>5</div>
                            <div className="cell-muted">Estados de flujo</div>
                        </div>
                        <div>
                            <div className="card-stat-num" style={{ fontSize: "2.2rem" }}>100%</div>
            ...
            <section className="features-section" id="features">
                ...
                <div className="features-grid">
                    <div className="feat-card feat-large">
                        <div className="feat-icon-wrap" style={{ background: "rgba(220,38,38,0.12)" }}>
                            <img
                    ...
                    <div className="feat-card">
                        <div className="feat-icon-wrap" style={{ background: "rgba(220,38,38,0.08)" }}>
                            <img
                    ...
                    <div className="feat-card feat-highlight">
                        <div className="feat-icon-wrap" style={{ background: "rgba(220,38,38,0.15)" }}>
                            <img
                                src="https://img.icons8.com/material/20/DC2626/star--v1.png"
                                alt=""
                                style={{ width: "20px", height: "20px" }}
                            />
                        </div>
            ...
            <section className="features-section" id="producers">
                ...
                <div className="features-grid">
                    ...
                    {/* Brayan - card */}
                    <div className="feat-card">
                        <div style={{ position: "relative", marginBottom: "1rem", borderRadius: "12px", overflow: "hidden", height: "140px" }}>
                            <img
                                src={brayanImg}
                    ...
                    <div className="feat-card">
                        ...
                        <p>
                            Productor musical e ingeniero de mezcla y master. Posicionado en el vallenato moderno junto con el cantante Luisra Solano y consolidado en sonidos urbanos.
                        </p>
                        <div className="flex-row-wrap" style={{ marginTop: "0.75rem" }}>
